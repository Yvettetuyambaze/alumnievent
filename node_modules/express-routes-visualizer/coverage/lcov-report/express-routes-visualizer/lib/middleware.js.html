...
<html lang="en">
<head>
    <title>Code coverage report for express-routes-visualizer/lib/middleware.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">express-routes-visualizer/lib</a> middleware.js
    </h1>
    <div class='clearfix'>
...
const determineHierarchy = (routeStack, includeHttpMethods = true) =&gt; {
  ...
  routeStack.map(element =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (element.route) {
      ...
      if (split.length === 1) {
        transformed[split[0]] = {}
        <span class="missing-if-branch" title="else path not taken" >E</span>if (includeHttpMethods) {
      ...
      for (const i in split) {
        ...
        if (existingElement) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (key !== '') {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (element.route.methods) {
              <span class="missing-if-branch" title="else path not taken" >E</span>if (includeHttpMethods) {
                Object.keys(element.route.methods).map(method =&gt; {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Feb 22 2019 15:07:32 GMT-0900 (Alaska Standard Time)
</div>
</div>
