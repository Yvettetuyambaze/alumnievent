...
<span class="cstat-no" title="statement not covered" >      console.err(`Error fetching RVR values from ${apiURI}`, err)</span>
    })
}
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (time &amp;&amp; date) {
          lastUpdated = {
            date,
            time
          }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sun Jul 22 2018 17:40:28 GMT-0800 (Alaska Daylight Time)
</div>
</div>
